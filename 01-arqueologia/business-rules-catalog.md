...
| BR-016 | Validacao cadastral aceita CPF com todos digitos iguais apenas quando prefixo inicial e `000` (excecao de teste governo). | `01-arqueologia/legado-sifap/natural-programs/VALBENEF.NSN#L195-L200` | `BENEFICIARIO.NUM-CPF` | ALTO | Excecao nao padrao ao algoritmo de CPF. |
